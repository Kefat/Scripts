...
[Script]
喜马拉雅签到任务 = type=cron,cronexp=35 8 * * *,script-path=https://raw.githubusercontent.com/ClydeTime/Quantumult/main/Script/Task/xmlySign.js
...
async function xmlySign(){
    let modifiedHeaders = $.getjson(name + "_headers")
    let headers = {
