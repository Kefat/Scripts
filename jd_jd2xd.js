  ...
  if (res && res [1]) {
    ...
    if (res && res.ret === 0) {
      ...
      for (let item of (expirejingdou || [])) {
        ...
        console.log(`${$.time('yyyy-MM-dd HH:mm:ss', item['time'] * 1000)}，将过期京豆：${item['expireamount']}`);
      }
      let todayExp = expirejingdou[0]['expireamount'] || 0;
      if (todayExp) {
        console.log(`\n今天将过期${todayExp}京豆`);
        console.log(`开始将今日要过期的${todayExp}个京豆兑换成喜豆`)
      ...
      console.log(`查询过期京豆异常：${$.toStr(res)}\n`);
    }
  }
}
